...
Teniendo esto en cuenta, que CREPE ha recibido mejoras después de su publicación original\footnote{\url{https://pypi.org/project/crepe/}}, que provee modelos de distintos tamaños según la compensación de velocidad y exactitud deseada y que su integración en el proyecto es más sencilla, se considera CREPE mejor opción que SPICE y es la elegida para estimar las frecuencias fundamentales.


\subsection{Descripción del proceso completo de la aplicación}
...
Después, se carga el audio de la canción como un vector de muestras normalizado. A partir del audio, se predice una lista de frecuencias en hercios empleando CREPE, cada predicción con un nivel de confianza asociado.
